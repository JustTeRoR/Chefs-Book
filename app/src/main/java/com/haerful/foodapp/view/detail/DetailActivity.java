...
import static com.haerful.foodapp.view.home.HomeActivity.EXTRA_DETAIL;
...
public class DetailActivity extends AppCompatActivity implements DetailView {
    ...
    public void setMeal(Meal meal) {
        Picasso.get().load(meal.getImage()).into(mealThumb);
        collapsingToolbarLayout.setTitle(meal.getName());
        category.setText(meal.getCategory());
        country.setText(meal.getCountry());
        instructions.setText(meal.getRecipe());
        setupActionBar();
        //TODO add parsing for ingredients
        ingredients.append(meal.getIngridients());
/*
...
*/
        youtube.setOnClickListener(v -> {
            ...
            intentYoutube.setData(Uri.parse(meal.getYoutubeUrl()));
        ...
        source.setOnClickListener(v -> {
            ...
            intentSource.setData(Uri.parse(meal.getYoutubeUrl()));
